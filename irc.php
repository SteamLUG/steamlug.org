...
<?php include_once("includes/header.php"); ?>
		...
		<section>
			<article>
				...
				<p>If you are new to our community, please take the time to read our short community <a href = '#coc'>Code of Conduct</a> below :)</p>
				<dl>
			...
			<article>
				<div class = 'shadow'>
				<iframe src="http://webchat.freenode.net?channels=steamlug" width = "100%" height = "600">
			...
			<article id = 'coc'>
				...
				<ul>
					...
					<li><a href="http://meklu.org/">meklu</a></li>
