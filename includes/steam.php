...
class SteamSignIn
{
	...
	const STEAM_LOGOUT = 'https://steamcommunity.com/login/logout';
	...
	*/
	...
	{
		if (!isset($_GET['openid_assoc_handle']) || !isset($_GET['openid_signed']) || !isset($_GET['openid_sig']) || !isset($_GET['openid_claimed_id']))
		{
			return "";
		}
