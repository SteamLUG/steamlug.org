...
?>
		...
		<section>
			...
			<div class = 'shadow'>
				...
				<dt>Password</dt><dd><em>Ask in <a href = 'irc'>IRC</a> or see the description of one of our <a href = 'http://steamcommunity.com/groups/steamlug/events'>Steam group events</a> (requires membership)</em></dd>
				</dl>
			</div>
			</article>
